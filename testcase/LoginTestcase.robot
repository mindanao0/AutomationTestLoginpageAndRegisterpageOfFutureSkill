...
As a user, I want to login success with valid credential
    ...
    [Teardown]   user logout from future skill platfrom

As a user, I fail to login with invalid credentital
    When user login to future skill platform with ${email} and ${invalid_password}
    Then future skill should display home page and display message as "กรอกรหัสผ่านไม่ถูกต้อง"
